...
#######################################################################################
        ...
        self.Lbl_To.setStyleSheet("font-size : 25px")
        self.gridLayout_2.addWidget(self.Lbl_To, 2, 0, 1, 1)
        ...
        self.Lbl_From.setStyleSheet("font-size : 25px;")

        self.gridLayout_2.addWidget(self.Lbl_From, 1, 0, 1, 1)

        self.Lbl_All_OrdersNum = QLabel(self.postSales)
        self.Lbl_All_OrdersNum.setObjectName(u"Lbl_All_OrdersNum")
        self.Lbl_All_OrdersNum.setMinimumSize(QSize(290, 40))
        self.Lbl_All_OrdersNum.setMaximumSize(QSize(290, 40))
        self.Lbl_All_OrdersNum.setAlignment(Qt.AlignCenter)
        self.Lbl_All_OrdersNum.setStyleSheet("font-size : 25px;")

        self.gridLayout_2.addWidget(self.Lbl_All_OrdersNum, 3, 0, 1, 1)
        ...
        self.btn_cal_Reset.setMinimumSize(QSize(290, 50))
        self.btn_cal_Reset.setMaximumSize(QSize(290, 50))
        self.btn_cal_Reset.setStyleSheet(u'''background-color: red;
                                             font: NanumGothic;
                                             font: 30px;''')
        ...
        self.btn_cal_priod.setMinimumSize(QSize(290, 50))
        self.btn_cal_priod.setMaximumSize(QSize(290, 50))
        self.btn_cal_priod.setStyleSheet(u'''background-color: #D69803;
                                             font: NanumGothic;
                                             font: 30px;''')

        self.gridLayout_2.addWidget(self.btn_cal_priod, 5, 0, 1, 1)

        self.gridLayout_2.addWidget(self.btn_cal_Reset, 4, 0, 1, 1)
        ...
        self.cal_daily_sales.setMinimumSize(QSize(290, 350))
        self.cal_daily_sales.setMaximumSize(QSize(290, 350))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_dinoagg.setText(QCoreApplication.translate("MainWindow", u"\ucc39\uc300\ub3c4\ub108\uce20", None))
        ...
        self.btn_cal_Reset.setText(QCoreApplication.translate("MainWindow", u"\ucd08\uae30\ud654", None))
