...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # widgets.btn_14_4_Add.clicked.connect(self.row_Button_Click)
        ...
        # widgets.btn_14_4_Sub.clicked.connect(self.row_Button_Click)
        ...
        # widgets.btn_14_5_Del.clicked.connect(self.row_Button_Click)
        # for i in range(all_Row):
        #     if(self.ui.tableWidget.cellWidget(i, 4) in QPushButton(f"Btn_{i}_4_Add") == None):
        #         break
        #     elif(widgets in QPushButton(f"Btn_{i}_4_Add") == True):
        #         widgets.tableWidget.QPushButton(f"Btn_{i}_4_Add").clicked.connect(self.row_Button_Click())
        #         widgets.QPushButton(f"Btn_{i}_4_Sub").clicked.connect(self.row_Button_Click())
        #         widgets.QPushButton(f"Btn_{i}_5_Del").clicked.connect(self.row_Button_Click())
        ...
        if self.ui.tableWidget.item(rowPlaceNum, colPlaceNum) != None:
            for _ in range(len(rows)):
                if self.ui.tableWidget.item(rowPlaceNum, colPlaceNum) == None:
                        ...
                        # 5열 갯수 추가/제거 버튼 추가
                        colPlaceNum += 1
                        self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, QPushButton(f"btn_{rowPlaceNum}_{colPlaceNum}_Add"))
                        self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, QPushButton(f"btn_{rowPlaceNum}_{colPlaceNum}_Sub"))
                        # 6열 행 제거 버튼 추가
                        colPlaceNum += 1
                        self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, QPushButton(f"btn_{rowPlaceNum}_{colPlaceNum}_Del"))
                        break
            ...
            if self.ui.tableWidget.item(rowPlaceNum, colPlaceNum) == None:
                ...
                if rowPlaceNum == 0:
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_0_4_Add)
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_0_4_Sub)
                    colPlaceNum += 1
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_0_5_Del)
                elif rowPlaceNum == 1:
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_1_4_Add)
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_1_4_Sub)
                    colPlaceNum += 1
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_1_5_Del)
                elif rowPlaceNum == 2:
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_2_4_Add)
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_2_4_Sub)
                    colPlaceNum += 1
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_2_5_Del)
                elif rowPlaceNum == 3:
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_3_4_Add)
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_3_4_Sub)
                    colPlaceNum += 1
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_3_5_Del)
                elif rowPlaceNum == 4:
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_4_4_Add)
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_4_4_Sub)
                    colPlaceNum += 1
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_4_5_Del)
                elif rowPlaceNum == 5:
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_5_4_Add)
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_5_4_Sub)
                    colPlaceNum += 1
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_5_5_Del)
                elif rowPlaceNum == 6:
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_6_4_Add)
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_6_4_Sub)
                    colPlaceNum += 1
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_6_5_Del)
                elif rowPlaceNum == 7:
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_7_4_Add)
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_7_4_Sub)
                    colPlaceNum += 1
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_7_5_Del)
                elif rowPlaceNum == 8:
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_8_4_Add)
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_8_4_Sub)
                    colPlaceNum += 1
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_8_5_Del)
                elif rowPlaceNum == 9:
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_9_4_Add)
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_9_4_Sub)
                    colPlaceNum += 1
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_9_5_Del)
                elif rowPlaceNum == 10:
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_10_4_Add)
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_10_4_Sub)
                    colPlaceNum += 1
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_10_5_Del)
                elif rowPlaceNum == 11:
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_11_4_Add)
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_11_4_Sub)
                    colPlaceNum += 1
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_11_5_Del)
                elif rowPlaceNum == 12:
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_12_4_Add)
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_12_4_Sub)
                    colPlaceNum += 1
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_12_5_Del)
                elif rowPlaceNum == 13:
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_13_4_Add)
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_13_4_Sub)
                    colPlaceNum += 1
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_13_5_Del)
                elif rowPlaceNum == 14:
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_14_4_Add)
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_14_4_Sub)
                    colPlaceNum += 1
                    self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, self.ui.btn_14_5_Del)

                # self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, QPushButton(f"btn_{rowPlaceNum}_{colPlaceNum}_Add"))
                # QPushButton(f"btn_{rowPlaceNum}_{colPlaceNum}_Add").setMinimumSize(QSize(40, 26))
                # QPushButton(f"btn_{rowPlaceNum}_{colPlaceNum}_Add").setMaximumSize(QSize(40, 26))
                # QPushButton(f"btn_{rowPlaceNum}_{colPlaceNum}_Add").setText('추가')
                # self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, QPushButton(f"btn_{rowPlaceNum}_{colPlaceNum}_Sub"))
                # QPushButton(f"btn_{rowPlaceNum}_{colPlaceNum}_Add").setMinimumSize(QSize(40, 26))
                # QPushButton(f"btn_{rowPlaceNum}_{colPlaceNum}_Add").setMaximumSize(QSize(40, 26))
                # QPushButton(f"btn_{rowPlaceNum}_{colPlaceNum}_Add").setText('삭제')
                # Widget(rowPlaceNum, colPlaceNum, self.make_Del_Button(rowPlaceNum, colPlaceNum)[1])
                # 6열 행 제거 버튼 추가
                # colPlaceNum += 1
                # self.ui.tableWidget.setCellWidget(rowPlaceNum, colPlaceNum, QPushButton(f"btn_{rowPlaceNum}_{colPlaceNum}_Del"))
                # QPushButton(f"btn_{rowPlaceNum}_{colPlaceNum}_Add").setMinimumSize(QSize(26, 26))
                # QPushButton(f"btn_{rowPlaceNum}_{colPlaceNum}_Add").setMaximumSize(QSize(26, 26))
                # QPushButton(f"btn_{rowPlaceNum}_{colPlaceNum}_Add").setText('X')
    ...
    #     layout = QHBoxLayout(cellWidget)
    #     # 버튼 생성
    #     btn_rowPlaceNum_colPlaceNum_Add = QPushButton()
    #     btn_rowPlaceNum_colPlaceNum_Add.setMinimumSize(QSize(70, 26))
    #     btn_rowPlaceNum_colPlaceNum_Add.setMaximumSize(QSize(70, 26))
    #     btn_rowPlaceNum_colPlaceNum_Add.setText('추가')
    #     # # 새로 만든 버튼 오브젝트 네임 설정
    #     # btn_Add.setObjectName(f"Btn_{rowPlaceNum}_{colPlaceNum}_Add")
    #     # 버튼 생성
    #     btn_rowPlaceNum_colPlaceNum_Sub = QPushButton()
    #     btn_rowPlaceNum_colPlaceNum_Sub.setMinimumSize(QSize(70, 26))
    #     btn_rowPlaceNum_colPlaceNum_Sub.setMaximumSize(QSize(70, 26))
    #     btn_rowPlaceNum_colPlaceNum_Sub.setText('제거')
    #     # # 새로 만든 버튼 오브젝트 네임 설정
    ...
    #     cellWidget.setLayout(layout)
    #     # 만들어진 위젯을 리턴
    #     return cellWidget, btn_rowPlaceNum_colPlaceNum_Add, btn_rowPlaceNum_colPlaceNum_Sub
