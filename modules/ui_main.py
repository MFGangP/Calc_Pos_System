...
"")
        ...
        self.btn_Cola = QPushButton(self.home)
        self.btn_Cola.setObjectName(u"btn_Cola")
        sizePolicy4.setHeightForWidth(self.btn_Cola.sizePolicy().hasHeightForWidth())
        self.btn_Cola.setSizePolicy(sizePolicy4)
        self.btn_Cola.setMinimumSize(QSize(120, 120))
        self.btn_Cola.setMaximumSize(QSize(290, 290))
        self.btn_Cola.setSizeIncrement(QSize(0, 0))
        self.btn_Cola.setBaseSize(QSize(120, 120))
        self.btn_Cola.setStyleSheet(u"background-color: #bd93f9;")

        self.gridLayout_3.addWidget(self.btn_Cola, 3, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btn_Fanta, 3, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btn_cider, 3, 4, 1, 1)
        ...
        self.btn_none.setMinimumSize(QSize(120, 120))
        self.btn_none.setMaximumSize(QSize(290, 290))
        self.btn_none.setSizeIncrement(QSize(0, 0))
        self.btn_none.setBaseSize(QSize(120, 120))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.titleLeftApp.setText(QCoreApplication.translate("MainWindow", u"TwistBread", None))
        ...
        self.btn_Cola.setText(QCoreApplication.translate("MainWindow", u"\ucf5c\ub77c", None))
